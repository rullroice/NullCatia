...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-06-2025 a las 00:52:27
...
--
-- Estructura de tabla para la tabla `cat_parchment`
--
...
--
-- Volcado de datos para la tabla `cat_parchment`
--
...
--
-- Estructura de tabla para la tabla `parchments`
--
...
--
-- Volcado de datos para la tabla `parchments`
--
...
--
-- Volcado de datos para la tabla `scrolls`
--
...
--
-- Indices de la tabla `cat_parchment`
--
...
--
-- Indices de la tabla `parchments`
--
...
--
-- AUTO_INCREMENT de la tabla `parchments`
--
ALTER TABLE `parchments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- Filtros para la tabla `cat_parchment`
--
ALTER TABLE `cat_parchment`
...
--
-- Filtros para la tabla `parchments`
--
ALTER TABLE `parchments`
